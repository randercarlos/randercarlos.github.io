  ...
  [354],
  {
    ...
    1695: (e, t, n) => {
      ...
      e.exports = function (e, t) {
        var n,
          ...
          g = e.global,
          m = e.stat;
        if ((n = g ? r : m ? r[h] || a(h, {}) : (r[h] || {}).prototype))
          for (u in t) {
            if (
              ((d = t[u]),
    ...
    1557: (e, t, n) => {
      ...
      e.exports = function (e, t, n, v) {
        ...
        if (E) {
          var x = E.prototype;
          if ((!m && i(x, "cause") && delete x.cause, !n)) return E;
          var T = r("Error"),
            I = t(function (e, t) {
              ...
              return (
                ...
                h && o(r, "stack", p(r.stack, 2)),
                this && s(x, this) && u(r, this, I),
          ...
          if (
            ...
            "Error" !== w
              ? a
                ? a(I, T)
                : c(I, T, { name: !0 })
              : g && y in E && (l(I, E, y), l(I, E, "prepareStackTrace")),
            c(I, E),
            !m)
          )
            try {
              x.name !== w && o(x, "name", w), (x.constructor = I);
            } catch (e) {}
          return I;
        }
      };
