      ...
      class ImageCarousel extends elementorModules.frontend.handlers
        ...
        getSwiperSettings() {
          ...
          Object.keys(n)
            ...
            s
              ? ((a.effect = e.effect),
                "fade" === e.effect && (a.fadeEffect = { crossFade: !0 }))
              : (a.slidesPerGroup = +e.slides_to_scroll || 1),
            e.image_spacing_custom && (a.spaceBetween = this.getSpaceBetween());
        ...
        updateSpaceBetween(e) {
          ...
          "desktop" !== s &&
            (this.swiper.params.breakpoints[
              elementorFrontend.config.responsive.activeBreakpoints[s].value
            ].spaceBetween = n),
