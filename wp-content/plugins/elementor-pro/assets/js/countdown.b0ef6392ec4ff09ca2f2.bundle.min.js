      ...
      var n = elementorModules.frontend.handlers.Base.extend({
        ...
        updateClock() {
          ...
          jQuery.each(t.parts, function (t) {
            ...
            let a = this.toString();
            1 === a.length && (a = 0 + a), n.length && n.text(a);
          }),
            t.total <= 0 &&
        ...
        getTimeRemaining(e) {
          ...
          return (
            (o < 0 || r < 0 || a < 0) && (n = a = r = o = 0),
            { total: t, parts: { days: o, hours: r, minutes: a, seconds: n } }
          );
        },
        getEvergreenDate() {
          const e = this,
            ...
            a = t + "-evergreen_due_date",
            r = t + "-evergreen_interval",
            o = {
              dueDate: localStorage.getItem(a),
            ...
            initEvergreen = function () {
              ...
              return (
                ...
                localStorage.setItem(a, e.cache.data.endTime),
