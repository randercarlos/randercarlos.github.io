        ...
        a = elementorModules.frontend.handlers.Base.extend({
            ...
            this.elements.$dynamicText.each(function () {
              ...
              t.empty(),
                i.forEach(function (i) {
                  var s = jQuery("<span>", { class: e.dynamicLetter }).text(i);
                  n && s.addClass(e.animationIn), t.append(s);
                }),
                t.css("opacity", 1);
            });
          },
          ...
          showWord(e, t) {
            ...
            "typing" === s
              ...
              : "clip" === s &&
                i.elements.$dynamicWrapper.animate(
                  { width: e.width() + 10 },
                  n.revealDuration,
                  function () {
                    setTimeout(function () {
                ...
                t.elements.$dynamicWrapper.addClass(n.typeSelected),
                  setTimeout(function () {
                    t.elements.$dynamicWrapper.removeClass(n.typeSelected),
                      e
                        .addClass(i.classes.textInactive)
