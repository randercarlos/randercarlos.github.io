      ...
      var n = elementorModules.frontend.handlers.Base.extend({
        ...
        getConfig() {
          const e = this.getElementSettings(),
            ...
            s = this.isContainerElement(this.$element[0].parentElement),
            i = this.isContainerElement(this.$element[0]) && s,
            o = this.$element[0].classList.contains("elementor-widget");
          return (
            n.length &&
              "top" === e.sticky &&
              "fixed" === n.css("position") &&
              (t.offset += n.height()),
            (t.relativeTarget = s ? "document" : "parent"),
            e.sticky_parent &&
              (i || o) &&
              (t.parent =
