    ...
    4519: (e, t, n) => {
      ...
      class IconsManager {
        ...
        createSvgElement(e, t) {
          ...
          return (
            (a.innerHTML = '<use xlink:href="' + l + '" />'),
            a.setAttributeNS(null, "class", "e-font-icon-svg e-" + r),
            a
          );
        }
      }
      (t.default = IconsManager),
        (0, s.default)(IconsManager, "symbolsContainer", void 0),
        (0, s.default)(IconsManager, "iconsUsageList", []);
    },
    4042: (e, t, n) => {
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
